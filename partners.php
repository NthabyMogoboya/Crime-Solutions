    ...
    <section class="ftco-consultation">
    	<div class="container-fluid">
    		<div class="row d-md-flex">
    			<div class="half order-md-last mt-md-0 d-flex justify-content-center align-items-center img" style="background-image: url(images/crime what what.jpg);">
    				<div class="overlay"></div>
          ...
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
				...
				<ul>
	                ...
	                <li><a href="#"><span class="icon icon-phone"></span><span class="text">+27 792 3929 210</span></a></li>
	                <li><a href="#"><span class="icon icon-envelope"></span><span class="text">CASinfo@mail.com</span></a></li>
	              </ul>
	            </div>
            </div>
          </div>
