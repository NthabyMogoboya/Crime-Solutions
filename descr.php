...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg nav border-bottom">
      ...
      <div style="text-align: center; font-size: larger; margin-left: 300px; margin-bottom: 500; margin-top: 500; color: white;">
        <label >Describe the crime</label><br>
        <textarea type="text"></textarea>

        <br><br><br><br><br><br>
        <a href="victim_dashboard.php"></a><button type="button" onclick="alert('Message was Succesfully Sent!')">Submit!</button></a>
      </div>
    </div>
   ...
   <script src="js/jquery.min.js"></script>
    ...
    <script rc="js/owl.carousel.min.js"></script>
